...
class Course(models.Model):
    ...
    description = models.TextField(verbose_name='описание', help_text="Добавьте описание к курсу")
...
class Lesson(models.Model):
    ...
    description = models.TextField(verbose_name='описание', help_text="Добавьте описание к уроку")
