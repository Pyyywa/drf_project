...
class CourseModeratorTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.preview = SimpleUploadedFile("test_course.webp", b"file_content", content_type="image/webp")
        self.preview2 = SimpleUploadedFile("test_lesson.webp", b"file_content", content_type="image/webp")
